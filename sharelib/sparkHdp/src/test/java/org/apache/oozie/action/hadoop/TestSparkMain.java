...
public class TestSparkMain extends MainTestCase {
    ...
    public Void call() throws Exception {
        ...
        SparkMainHdp.main(args);
        assertTrue(getFileSystem().exists(new Path(getFsTestCaseDir() + "/" + OUTPUT)));
        return null;
    }

    public void testPatterns() {
        patternHelper("spark-yarn", SparkMainHdp.SPARK_YARN_JAR_PATTERN);
        patternHelper("spark-assembly", SparkMainHdp.SPARK_ASSEMBLY_JAR_PATTERN);
    }
